...
void startConfig() {
  ...
  if (loraMode==11) {
    ...
    PRINT_CSTSTR("%s","^$Channel CH_17_868: state ");    
  }
  else {
  ...
  sx1272.writeRegister(0xA,0x9);
  sx1272.writeRegister(0xB,0x2B);
  sx1272.writeRegister(0xC,0x20);
  sx1272.writeRegister(0xD,0x31);
  sx1272.writeRegister(0xE,0x0);
  */
